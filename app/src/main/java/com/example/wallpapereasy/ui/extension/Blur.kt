package com.example.wallpapereasy.ui.extension
...
fun ImageView.loadBlurredImageWithPlaceholder( imageUrl: String?, placeholderColor: String?,
                                               placeholderRadius: Float = 25f, size: Int = 100 ) {
